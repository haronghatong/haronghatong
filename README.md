...
|2024.09~2024.12|뉴스 정보 정리 플랫폼|MAKE와 Python을 이용한 뉴스 서칭 및 커뮤니티 생성|-|Pyton(openai),MAKE| 학교수업(팀과제)
...
| Period                  | Title                                                                                                                                             | Description                                                                                | Role                   | Tech Stack                                                                                    | Result                                                       |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------| 
|2024.07~2024.09|자율주행 인공지능 알고리즘 개발(챌린지)도로 데이터를 통한 객체감지 정확도 향상|||Python(pytorch,Tensorflow),Linux|
||||||
||||||
||||||
